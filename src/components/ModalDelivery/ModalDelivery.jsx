...
import { changeTouch, submitForm, updateFormValue,
  validateForm} from "../../store/form/formSlice";
...
if(Object.keys(form.errors).length === 0 && form.touch) {
  ...
  return isOpen && (
    <div className={style.modal} // currentTarget указывает на эл. в котором он наход.
